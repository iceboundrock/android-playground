...
public class WaveProgressView extends View {
    ...
    private static class MyHandler extends Handler {
        private WeakReference<WaveProgressView> mWeakRef = null;

        private int refreshPeriod = 100;

        public MyHandler(WaveProgressView host) {
            mWeakRef = new WeakReference<WaveProgressView>(host);
        }
    ...
    public WaveProgressView(Context paramContext) {
        super(paramContext);
    }
